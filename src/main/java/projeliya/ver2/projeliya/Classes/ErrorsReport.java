...
{
    private ArrayList<String> liistOfSucsses;    
    ...
    public ErrorsReport(ArrayList<String> liistOfSucsses, ArrayList<String> errorsArraysExplain, Boolean timeRunTest,
            Boolean memoryTest, String runTimeOfFunc, Point[] arrayOfPoints, long[] arrayOfSlope,
            long[] arrayOfDistance) 
            {
        this.liistOfSucsses = liistOfSucsses;
    ...
    public ArrayList<String> getLiistOfSucsses() {
        return liistOfSucsses;
    }




    public void setLiistOfSucsses(ArrayList<String> liistOfSucsses) {
        this.liistOfSucsses = liistOfSucsses;
    }
